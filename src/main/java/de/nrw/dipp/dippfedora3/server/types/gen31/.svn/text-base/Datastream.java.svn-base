...
public class Datastream  implements java.io.Serializable {
    private de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamControlGroup controlGroup;
    ...
    public Datastream(
           de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamControlGroup controlGroup,
           java.lang.String ID,
     ...
     * @return controlGroup
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamControlGroup getControlGroup() {
        return controlGroup;
    }
     ...
     * @param controlGroup
     */
    public void setControlGroup(de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamControlGroup controlGroup) {
        this.controlGroup = controlGroup;
    }
