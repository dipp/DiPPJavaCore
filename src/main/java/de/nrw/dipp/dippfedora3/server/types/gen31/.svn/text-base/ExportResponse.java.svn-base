...
public class ExportResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the objectXML value for this ExportResponse.
     * 
     * @return objectXML
     */
    ...
    /**
     * Sets the objectXML value for this ExportResponse.
     * 
     * @param objectXML
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.fedora.info/definitions/1/0/types/", ">exportResponse"));
