...
public class DatastreamBindingMap  implements java.io.Serializable {
    ...
    private de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamBinding[] dsBindings;
    ...
    public DatastreamBindingMap(
           ...
           de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamBinding[] dsBindings) {
     ...
     * @return dsBindings
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamBinding[] getDsBindings() {
        return dsBindings;
    }
     ...
     * @param dsBindings
     */
    public void setDsBindings(de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamBinding[] dsBindings) {
        this.dsBindings = dsBindings;
    }
    ...
    static {
        ...
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "dsBinding"));
        typeDesc.addFieldDesc(elemField);
    }
