...
public class FedoraAPIAServiceLocator extends org.apache.axis.client.Service implements de.nrw.dipp.dippfedora3.server.access31.FedoraAPIAService {
    ...
    public de.nrw.dipp.dippfedora3.server.access31.FedoraAPIA getFedoraAPIAPortSOAPHTTPS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.nrw.dipp.dippfedora3.server.access31.FedoraAPIA.class.isAssignableFrom(serviceEndpointInterface)) {
                de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub(new java.net.URL(FedoraAPIAPortSOAPHTTPS_address), this);
                _stub.setPortName(getFedoraAPIAPortSOAPHTTPSWSDDServiceName());
                return _stub;
            }
            if (de.nrw.dipp.dippfedora3.server.access31.FedoraAPIA.class.isAssignableFrom(serviceEndpointInterface)) {
                de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.access31.FedoraAPIABindingSOAPHTTPStub(new java.net.URL(FedoraAPIAPortSOAPHTTP_address), this);
                _stub.setPortName(getFedoraAPIAPortSOAPHTTPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("Fedora-API-A-Port-SOAPHTTPS".equals(inputPortName)) {
            return getFedoraAPIAPortSOAPHTTPS();
        }
        else if ("Fedora-API-A-Port-SOAPHTTP".equals(inputPortName)) {
