...
public class MethodParmDef  implements java.io.Serializable {
    ...
    private de.nrw.dipp.dippfedora3.server.types.gen31.PassByRef PASS_BY_REF;

    private de.nrw.dipp.dippfedora3.server.types.gen31.PassByValue PASS_BY_VALUE;

    private de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamInputType DATASTREAM_INPUT;

    private de.nrw.dipp.dippfedora3.server.types.gen31.UserInputType USER_INPUT;

    private de.nrw.dipp.dippfedora3.server.types.gen31.DefaultInputType DEFAULT_INPUT;
    ...
    public MethodParmDef(
           ...
           de.nrw.dipp.dippfedora3.server.types.gen31.PassByRef PASS_BY_REF,
           de.nrw.dipp.dippfedora3.server.types.gen31.PassByValue PASS_BY_VALUE,
           de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamInputType DATASTREAM_INPUT,
           de.nrw.dipp.dippfedora3.server.types.gen31.UserInputType USER_INPUT,
           de.nrw.dipp.dippfedora3.server.types.gen31.DefaultInputType DEFAULT_INPUT) {
     ...
     * @return PASS_BY_REF
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.PassByRef getPASS_BY_REF() {
        return PASS_BY_REF;
    }
     ...
     * @param PASS_BY_REF
     */
    public void setPASS_BY_REF(de.nrw.dipp.dippfedora3.server.types.gen31.PassByRef PASS_BY_REF) {
        this.PASS_BY_REF = PASS_BY_REF;
    }
     ...
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.PassByValue getPASS_BY_VALUE() {
        return PASS_BY_VALUE;
    }
     ...
     * @param PASS_BY_VALUE
     */
    public void setPASS_BY_VALUE(de.nrw.dipp.dippfedora3.server.types.gen31.PassByValue PASS_BY_VALUE) {
        this.PASS_BY_VALUE = PASS_BY_VALUE;
    }
     ...
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamInputType getDATASTREAM_INPUT() {
        return DATASTREAM_INPUT;
    }
     ...
     */
    public void setDATASTREAM_INPUT(de.nrw.dipp.dippfedora3.server.types.gen31.DatastreamInputType DATASTREAM_INPUT) {
        this.DATASTREAM_INPUT = DATASTREAM_INPUT;
    }
     ...
     * @return USER_INPUT
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.UserInputType getUSER_INPUT() {
        return USER_INPUT;
    }
     ...
     * @param USER_INPUT
     */
    public void setUSER_INPUT(de.nrw.dipp.dippfedora3.server.types.gen31.UserInputType USER_INPUT) {
        this.USER_INPUT = USER_INPUT;
    }
     ...
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.DefaultInputType getDEFAULT_INPUT() {
        return DEFAULT_INPUT;
    }
     ...
     * @param DEFAULT_INPUT
     */
    public void setDEFAULT_INPUT(de.nrw.dipp.dippfedora3.server.types.gen31.DefaultInputType DEFAULT_INPUT) {
        this.DEFAULT_INPUT = DEFAULT_INPUT;
    }
