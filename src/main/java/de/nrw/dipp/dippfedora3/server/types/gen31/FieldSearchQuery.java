...
public class FieldSearchQuery  implements java.io.Serializable {
    private de.nrw.dipp.dippfedora3.server.types.gen31.Condition[] conditions;
    ...
    public FieldSearchQuery(
           de.nrw.dipp.dippfedora3.server.types.gen31.Condition[] conditions,
     ...
     * @return conditions
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.Condition[] getConditions() {
        return conditions;
    }
     ...
     * @param conditions
     */
    public void setConditions(de.nrw.dipp.dippfedora3.server.types.gen31.Condition[] conditions) {
        this.conditions = conditions;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("", "condition"));
