...
public class FedoraAPIMServiceLocator extends org.apache.axis.client.Service implements de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMService {
    ...
    public de.nrw.dipp.dippfedora3.server.management31.FedoraAPIM getFedoraAPIMPortSOAPHTTPS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.nrw.dipp.dippfedora3.server.management31.FedoraAPIM.class.isAssignableFrom(serviceEndpointInterface)) {
                de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub(new java.net.URL(FedoraAPIMPortSOAPHTTPS_address), this);
                _stub.setPortName(getFedoraAPIMPortSOAPHTTPSWSDDServiceName());
                return _stub;
            }
            if (de.nrw.dipp.dippfedora3.server.management31.FedoraAPIM.class.isAssignableFrom(serviceEndpointInterface)) {
                de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub _stub = new de.nrw.dipp.dippfedora3.server.management31.FedoraAPIMBindingSOAPHTTPStub(new java.net.URL(FedoraAPIMPortSOAPHTTP_address), this);
                _stub.setPortName(getFedoraAPIMPortSOAPHTTPWSDDServiceName());
                return _stub;
            }
        }
