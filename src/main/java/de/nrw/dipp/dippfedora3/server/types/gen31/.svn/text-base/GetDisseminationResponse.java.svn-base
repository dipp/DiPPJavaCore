...
public class GetDisseminationResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the dissemination value for this GetDisseminationResponse.
     * 
    ...
    /**
     * Sets the dissemination value for this GetDisseminationResponse.
     * 
     * @param dissemination
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetDisseminationResponse)) return false;
        GetDisseminationResponse other = (GetDisseminationResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDisseminationResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.fedora.info/definitions/1/0/types/", ">getDisseminationResponse"));
