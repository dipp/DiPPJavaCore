...
public class Condition  implements java.io.Serializable {
    ...
    private de.nrw.dipp.dippfedora3.server.types.gen31.ComparisonOperator operator;
    ...
    public Condition(
           ...
           de.nrw.dipp.dippfedora3.server.types.gen31.ComparisonOperator operator,
     ...
     * @return operator
     */
    public de.nrw.dipp.dippfedora3.server.types.gen31.ComparisonOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(de.nrw.dipp.dippfedora3.server.types.gen31.ComparisonOperator operator) {
        this.operator = operator;
    }
