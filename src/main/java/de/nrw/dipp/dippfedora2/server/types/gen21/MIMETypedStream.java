...
public class MIMETypedStream  implements java.io.Serializable {
    ...
    private de.nrw.dipp.dippfedora2.server.types.gen21.Property[] header;
    ...
    public MIMETypedStream(
           ...
           byte[] stream,
           de.nrw.dipp.dippfedora2.server.types.gen21.Property[] header) {
     ...
     * @return header
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.Property[] getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(de.nrw.dipp.dippfedora2.server.types.gen21.Property[] header) {
        this.header = header;
    }
