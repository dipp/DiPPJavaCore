...
public class FieldSearchResult  implements java.io.Serializable {
    private de.nrw.dipp.dippfedora2.server.types.gen21.ListSession listSession;

    private de.nrw.dipp.dippfedora2.server.types.gen21.ObjectFields[] resultList;

    public FieldSearchResult() {
    }

    public FieldSearchResult(
           de.nrw.dipp.dippfedora2.server.types.gen21.ListSession listSession,
           de.nrw.dipp.dippfedora2.server.types.gen21.ObjectFields[] resultList) {
     ...
     * @return listSession
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.ListSession getListSession() {
        return listSession;
    }
     ...
     * @param listSession
     */
    public void setListSession(de.nrw.dipp.dippfedora2.server.types.gen21.ListSession listSession) {
        this.listSession = listSession;
    }
     ...
     * @return resultList
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.ObjectFields[] getResultList() {
        return resultList;
    }
     ...
     * @param resultList
     */
    public void setResultList(de.nrw.dipp.dippfedora2.server.types.gen21.ObjectFields[] resultList) {
        this.resultList = resultList;
    }
