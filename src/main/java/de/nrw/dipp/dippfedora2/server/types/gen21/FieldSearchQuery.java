...
public class FieldSearchQuery  implements java.io.Serializable {
    private de.nrw.dipp.dippfedora2.server.types.gen21.Condition[] conditions;
    ...
    public FieldSearchQuery(
           de.nrw.dipp.dippfedora2.server.types.gen21.Condition[] conditions,
     ...
     * @return conditions
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.Condition[] getConditions() {
        return conditions;
    }
     ...
     * @param conditions
     */
    public void setConditions(de.nrw.dipp.dippfedora2.server.types.gen21.Condition[] conditions) {
        this.conditions = conditions;
    }
