...
public class DatastreamBindingMap  implements java.io.Serializable {
    ...
    private de.nrw.dipp.dippfedora2.server.types.gen21.DatastreamBinding[] dsBindings;
    ...
    public DatastreamBindingMap(
           ...
           de.nrw.dipp.dippfedora2.server.types.gen21.DatastreamBinding[] dsBindings) {
     ...
     * @return dsBindings
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.DatastreamBinding[] getDsBindings() {
        return dsBindings;
    }
     ...
     * @param dsBindings
     */
    public void setDsBindings(de.nrw.dipp.dippfedora2.server.types.gen21.DatastreamBinding[] dsBindings) {
        this.dsBindings = dsBindings;
    }
