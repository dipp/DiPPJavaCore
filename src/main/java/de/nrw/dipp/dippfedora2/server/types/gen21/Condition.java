...
/**
 * A property,operator,value expression that evaluates to true or
 * false.
 */
public class Condition  implements java.io.Serializable {
    private java.lang.String property;

    private de.nrw.dipp.dippfedora2.server.types.gen21.ComparisonOperator operator;
    ...
    public Condition(
           ...
           de.nrw.dipp.dippfedora2.server.types.gen21.ComparisonOperator operator,
     ...
     * @return operator
     */
    public de.nrw.dipp.dippfedora2.server.types.gen21.ComparisonOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(de.nrw.dipp.dippfedora2.server.types.gen21.ComparisonOperator operator) {
        this.operator = operator;
    }
