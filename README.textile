...
DiPPCore should be deployed as WebArchive (war) container within the Tomcat Web-Application Server. To generate the war-container run mvn clean compile war:war
